...
בפינה הימנית העליונה ב-Lovable, לחצו על כפתור GitHub (או Export/Sync).

התחברו לחשבון ה-GitHub שלכם.

בחרו ברשימה את הפרויקט שיצרתם על בסיס הטמפלייט.

לחצו Link Repo (או Push).
