...
2. התחברו (Login) וצרו פרויקט חדש (כתבו פרומפט ראשוני קצר ופשוט רק כדי לפתוח פרוייקט חדש).
3. בתפריט הצד ב-Lovable, חפשו את **Supabase** או **Project Settings > Integrations**.
...
6. שימו לב! מכיוון שכל הקבוצות עובדות תחת אותה סביבת עבודה אתם תהיו חשופים לבסיסי הנתונים של כל הקבוצות **חשוב מאוד לקרוא לארגון ולפרוייקט שלכם בשמות משמעותיים ולבחור בהם בעת החיבור לSupabase!** אחרת כל המידע שעבדתם עליו ישמר בפרוייקט של קבוצה אחרת מה שיהרוס לכם את העבודה ויפגע בעבודה של הקבוצה השנייה עם נתנונים לא רלוונטים. 
...
חיזרו לקובץ ההנחיות והמשיכו הלאה https://github.com/ofriwnmc/NMC-VibeAI-Hackathon/blob/main/README.md
