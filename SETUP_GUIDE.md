...
**שימו לב! אם אתם נשאלים לגבי חיבור לענן (Cloud) בחרו באפשרות DECLINE אל תתנו אישור לחיבור לענן מכיוון שזה יפגע בחיבור שלנו לבסיס הנתונים החיצוני**.
...
חיזרו לקובץ ההנחיות והמשיכו הלאה [README.md](./README.md) 
